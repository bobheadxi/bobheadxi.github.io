...
software development positions at startups like [Sumus Property Group](/sumus)
...
community of aspiring software engineers at my university. I also volunteered for as a
[web developer for nwPlus](https://bobheadxi.dev/nwhacks2019/) building the website and application
system behind one of the largest hackathons in western Canada, nwHacks.
...
[mountains, trees, making gifs that loop](https://pics.bobheadxi.dev/), reading,
and [occasionally writing](https://bobheadxi.dev/blog/) about my work and things that interest me
(all opinions are mine). I used to run pretty frequently and ran a full marathon a few years back.
More recently, I've been enjoying working on improving my bouldering, skateboarding, and snowboarding.
