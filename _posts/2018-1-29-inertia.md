...
is invaluable. We realized that we needed a tool that could make setting up
...
I built the majority of Inertia's core functionality and helped guide over 20
contributors (both internal and external) in making additions and new features
for the tool. I also created a [comprehensive suite of development tools and scripts](https://github.com/ubclaunchpad/inertia/blob/master/CONTRIBUTING.md#development-tips)
([code](https://github.com/ubclaunchpad/inertia/tree/master/test))
to improve how Inertia is developed, including things like disposable mock
remote hosts using Docker containers. I also established a complex
[Travis CI pipeline](https://github.com/ubclaunchpad/inertia/blob/master/.travis.yml)
that runs our complex suite of unit and integration tests against a wide range
of deployment targets (Ubuntu, CentOS, Debian, AmazonOS, etc.) automatically
...
I have also written a comprensive (if slightly outdated by now)
[Medium blog post](https://medium.com/ubc-launch-pad-software-engineering-blog/building-continuous-deployment-87a2bd8eedbe)
detailing what Inertia can do, how it works, and how we built it. Recently we
also set up a [documentation website](https://inertia.ubclaunchpad.com) that
guides users through Inertia's functionality.
...
- [Inertia 2018-2019 Recap](https://github.com/ubclaunchpad/slides/blob/master/projects/inertia/demo-3.pdf)

Some other relevant blog posts that were related to my work on Inertia:

- [Docker-in-Docker-in-Docker](https://bobheadxi.dev/dockerception/)
- [Travis CI pipeline optimizations](https://medium.com/ubc-launch-pad-software-engineering-blog/optimizing-travis-ci-pipelines-36973aea3758)
- [Automated documentation generation](https://medium.com/@bobheadxi/turning-slate-into-a-proper-documentation-builder-d0cf31abf459)

Inertia also inspired several spin-off side projects:
...
Bonus: [silly post about the Inertia logo and the project README](https://bobheadxi.dev/inertia-logo/).
:upside_down_face:
