...
* Some students from a Computer Engineering course at UBC reached out to conduct a security analysis of Inertia for their course project, which was super exciting! You can read their [comprehensive final report here](/assets/files/inertia-security-report.pdf) and see some of the follow-up changes that were made on [GitHub](https://github.com/ubclaunchpad/inertia) (such as [#638](https://github.com/ubclaunchpad/inertia/pull/638), [#637](https://github.com/ubclaunchpad/inertia/pull/637)).
