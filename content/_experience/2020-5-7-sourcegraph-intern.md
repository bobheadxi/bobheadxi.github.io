...
I also developed tooling to automate the upgrades of our [managed Sourcegraph instances offering](https://docs.sourcegraph.com/admin/install/managed) - a previously a very manual process - greatly reducing the time it takes to conduct an upgrade, and reducing the possibilty of mistakes.
