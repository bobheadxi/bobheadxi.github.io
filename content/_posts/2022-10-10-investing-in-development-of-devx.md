...
At [Sourcegraph](../_experience/2021-7-5-sourcegraph.md) we have a developer tool called `sg`, which has become the way we ensure the development of tooling continues to scale at Sourcegraph.
